...
def main():
    ...
    f.write(
        'GeneName_TC' + '\t' + 'GeneName_OGid' + '\t' + 'NoParalogOrListOfParalogs' + '\t' + 'ifParalogHasOrtholog' + '\t' + 'Ortholog' + '\n')
    f1 = open(namesp1 + '_final.txt', 'w')
    f1.write(
        'GeneName' + '\t' + 'ParalogsThatHaveOrthologs' + '\t' + 'GeneSymbolParalogs' + '\t' + 'Orthologs' + '\t' + 'GeneSymbolOrthologs' + '\n')
    ...
    with open(geneSet, 'r') as gS, open(namesp1 + '_temp.txt', 'a') as g1, open(namesp1 + '_final.txt', 'a') as f1:
        for line in gS:
            ...
            if geneName in dict_sp1id:
                    ...
                    for i in range(0, len(pc1[paralogListIndex[0]])):
                        ...
                        if pc1[paralogListIndex[0]][i] in dict_brh:
                            ...
                            if dict_brh[pc1[paralogListIndex[0]][i]] in dict_sp2id:
                                ...
                                g1.write(
                                    pc1[paralogListIndex[0]][i] + '--' + dict_brh[pc1[paralogListIndex[0]][i]] + '__' +
                                    dict_sp2id[dict_brh[pc1[paralogListIndex[0]][i]]])
                ...
                # if its not in 97pc file, it doesnt have any paralogs
                else:
                ...
                if dict_sp1id[geneName] in dict_brh:
                    ...
                    if dict_brh[dict_sp1id[geneName]] in dict_sp2id:
                        ...
                        g1.write(
                            '\t' + dict_brh[dict_sp1id[geneName]] + '__' + dict_sp2id[dict_brh[dict_sp1id[geneName]]])
